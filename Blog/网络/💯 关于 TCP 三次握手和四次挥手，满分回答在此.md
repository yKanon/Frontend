`转载 https://segmentfault.com/a/1190000039165592`
...
![](https://segmentfault.com/img/remote/1460000039165596)
...
⭐ 大家看上图，保留位的右边还有 6 个控制位（重要），这是 TCP 用来说明该报文段性质的：
...
- **终止 FIN**：用来释放一个连接。当 FIN = 1 时，表明此报文段的发送发的数据已发送完毕，并要求释放运输连接。
...
😁  下方扫码关注**公众号「飞天小牛肉」**（专注于分享计算机基础、Java 基础和面试指南的相关原创技术好文，帮助读者快速掌握高频重点知识，有的放矢），第一时间获取文章更新

🎉 并向大家强烈推荐我维护的 **Gitee 仓库** [CS-Wiki（Gitee 推荐项目，0.9k star）](https://link.segmentfault.com/?enc=kvGW25mfAyTce5ONOU8tPw%3D%3D.Ax2D9qDfQw%2BlZkT9wFDE79%2FoT4iHruSXoO3tBhU4uKL%2FxH9BXjew9ICEJ%2BUCGM5L) （面向全栈，致力于构建完善的知识体系：数据结构、计算机网络、操作系统、算法、数据库、设计模式、Java 技术栈、机器学习、深度学习、强化学习等），相比公众号，该仓库拥有更健全的知识体系，欢迎前来 star

---

❤ 最后，原创不易，一篇文章最少都是两三个小时起步，各位看官若有收获不凡点赞评论收藏三连支持一波呀~
